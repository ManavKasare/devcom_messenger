...
import 'package:devcom/chat.dart';
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Text(
                      ...
                      style: TextStyle(color: primaryColor, fontSize: 14.0, fontWeight: FontWeight.w300),
                    ),
                  ],
                ),
              ),
      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          ...
          appBar: PreferredSize(
              ...
              title: Text(
                'devcom',
                style: TextStyle(color: themeColor, fontSize: 18.0,fontWeight: FontWeight.bold),
              ),
              centerTitle: false,
              actions: <Widget>[
                // IconButton(
                ...
                //   color: themeColor,
                //   iconSize: 35.0,
                //   onPressed: () => onItemMenuPress('profile'),
                // ),
                Container(
                  padding: EdgeInsets.only(top: 5, right: 30),
                  child: InkWell(
                    onTap: () => onItemMenuPress('profile'),
                    child: Material(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        child: Text(
                          ...
                          style: TextStyle(color: primaryColor, fontSize: 12.0, fontWeight: FontWeight.w400),
                        ),
                        alignment: Alignment.centerLeft,
